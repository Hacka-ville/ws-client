  ...
  return (
    ...
    >
      <Timeline.Item bullet={<IconPlaneArrival size={12} />} title="Flights">
        ...
        <Text size="xs" mt={4}>
          <strong style={{ textTransform: "uppercase" }}>flights</strong> you
          can opt for
        </Text>
      </Timeline.Item>
      ...
      <Timeline.Item bullet={<IconHotelService size={12} />} title="Hotels">
        <Text color="dimmed" size="sm">
          Check all the various <strong>hotels</strong>
        </Text>
        <Text size="xs" mt={4}>
          Around 20.000
        </Text>
      ...
      <Timeline.Item title="Activities" bullet={<IconActivity size={12} />}>
        <Text color="dimmed" size="sm">
          <strong>Activities</strong> that will make your travel better!
        </Text>
        <Text size="xs" mt={4}>
          Over 1.000
        </Text>
      ...
      <Timeline.Item title="Payments" bullet={<IconBrandPaypal size={12} />}>
        ...
        <Text size="xs" mt={4} style={{ fontWeight: "bold" }}>
          Payment
        </Text>
      </Timeline.Item>
    </Timeline>
